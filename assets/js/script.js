...
const products = [
  { _id:1,  name:"Harina", type: 'viveres', score: randomNumber(1,5), totalRatings: randomNumber(20,200), price: 2000, image: 'harina.png' },
  { _id:2,  name:"Arroz", type: 'viveres', score: randomNumber(1,5), totalRatings: randomNumber(20,200), price: 1000, image: 'arroz.png' },
  { _id:3,  name:"Pasta", type: 'viveres', score: randomNumber(1,5), totalRatings: randomNumber(20,200), price: 1500, image: 'pasta.png' },
  { _id:4,  name:"Manzana", type: 'frutasVerduras', score: randomNumber(1,5), totalRatings: randomNumber(20,200), price: 1200, image: 'manzana.png' },
  { _id:5,  name:"Pera", type: 'frutasVerduras', score: randomNumber(1,5), totalRatings: randomNumber(20,200), price: 1800, image: 'pera.png' },
  { _id:6,  name:"Fresa", type: 'frutasVerduras', score: randomNumber(1,5), totalRatings: randomNumber(20,200), price: 2000, image: 'fresa.png' },
  { _id:7,  name:"Durazno", type: 'frutasVerduras', score: randomNumber(1,5), totalRatings: randomNumber(20,200), price: 2500, image: 'durazno.png' },
  { _id:8,  name:"Uva", type: 'frutasVerduras', score: randomNumber(1,5), totalRatings: randomNumber(20,200), price: 3000, image: 'uva.png' },
  { _id:9,  name:"Jugo de Naranja", type: 'bebidas', score: randomNumber(1,5), totalRatings: randomNumber(20,200), price: 1350, image: 'jugo.png' },
  { _id:10, name:"Refresco", type: 'bebidas', score: randomNumber(1,5), totalRatings: randomNumber(20,200), price: 1900, image: 'refresco.png' },
  { _id:11, name:"Agua Mineral", type: 'bebidas', score: randomNumber(1,5), totalRatings: randomNumber(20,200), price: 900, image: 'agua.png' },
]
...
class shoppingCartClass {
  ...
  addProduct(id,quantity) {
      ...
      if (existingProduct) {
        ...
        if (addedProduct){
          ...
          console.log("Sumaste " + quantity + " unidad(es) de " + existingProduct.name + " al Carrito!");
        } else {
          const product = {
            _id: id,
          ...
          console.log("Agregaste " + quantity + " unidad(es) de " + existingProduct.name + " al Carrito!");
        }
      } else {
  ...
  listCart() {
      ...
      this.products.forEach(product => {
        res += product.quantity + " unidad(es) de " + product.name + " por $" + product.price + " c/u.\n";
      })
      return res;
  }
  getTotalProducts() {
...
const renderProducts = (typeSelected) => {
  ...
  selectedProducts.forEach( product => {
    ...
    <div class="card border-0 rounded-0 shadow m-2" style="max-width: 18rem;">
      <img src="assets/img/${product.image}" class="card-img-top rounded-0" alt="...">
      <div class="card-body my-3">
        <div class="row">
          <div class="col-10">
            <h4 class="card-title"> ${product.name}</h4>
            <p class="card-text">
              ${ product.score >= 1 ? '<i class="bi bi-star-fill text-warning"></i>\n' : ''}
              ${ product.score >= 2 ? '<i class="bi bi-star-fill text-warning"></i>\n' : ''}
              ${ product.score >= 3 ? '<i class="bi bi-star-fill text-warning"></i>\n' : ''}
              ${ product.score >= 4 ? '<i class="bi bi-star-fill text-warning"></i>\n' : ''}
              ${ product.score >= 5 ? '<i class="bi bi-star-fill text-warning"></i>\n' : ''}
      ...
      <div class="row align-items-center text-center g-0">
        ...
        <div class="col-8 d-flex justify-content-start align-items-center bg-dark px-2">
          ...
          <div class="d-flex flex-column align-items-start">
            <div class="p-2 text-white"> <b> Cantidad: </b> 1 </div>
            <div class="p-2 text-white"> <b> Subtotal: </b> $1500 </div>
          </div>
        </div>
      </div>
      <div class="row align-items-center text-center g-0">
        <div class="col-12 d-flex justify-content-center">
          <div class="btn btn-danger text-warning w-50 p-3 rounded-0">
            Restar Unidad
          </div>
          <div class="btn btn-success text-warning w-50 p-3 rounded-0" >
            Sumar Unidad
          </div>
        </div>
      </div>
...
const productChoose = () => {
  ...
  if (response > 0 && response <= products.length) return quantityChoose(response);
...
const quantityChoose = (id) => {
  ...
  const response = parseInt(prompt('Cuantas unidades de ' + product.name + ' desea comprar (Cantidad del 1 al 10):'));
